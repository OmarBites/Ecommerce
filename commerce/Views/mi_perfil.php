            ...
            <div class="modal-body">
                <form id="form-contra">
                    <div class="form-group">
                        <label for="pass_old">Ingrese la contraseña actual</label>
                        <input type="password" name="pass_old" class="form-control" id="pass_old"
                            placeholder="Ingrese la contraseña actual">
                    </div>
                    <div class="form-group">
                        <label for="pass_new">Ingrese la nueva contraseña</label>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" enctype="multipart/form-data">
                <form id="form-datos">
                    ...
                    <div class="form-group">
                        <label for="dni_mod">Carnet de Identidad</label>
            ...
            <div class="col-md-3">
                ...
                <div class="card card-light">
                    <div class="card-header border-bottom-0">
                        ...
                        <div class="card-tools">
                            <button type="button" class="editar_datos btn btn-toll" data-bs-toggle="modal"
                            ...
                            <div class="col-8">
                                ...
                                <ul class="ml-4 mb-0 fa-ul text-muted">
                                    <li class="small"><span class="fa-li"><i class="fas fa-address-card"></i></span>
                                        Carnet de Identidad: <span id="dni"></span></li>
                                    <li class="small"><span class="fa-li"><i class="fas fa-at"></i></span>Email: <span
                                            id="email"></span></span></li>
                                    <li class="small"><span class="fa-li"><i class="fas fa-lg fa-phone"></i></span>
                                        Telefono/Celular: <span id="telefono"></span></li>
                                </ul>
                            </div>
                    ...
                    <div class="card-footer">
                        <button class="btn btn-warning btn-block" data-bs-toggle="modal"
                            data-bs-target="#modal_contra">Cambiar password</button>
                    </div>
                </div>
                ...
                <div class="card card-light">
                    <div class="card-header border-bottom-0">
                        ...
                        <div class="card-tools">
                            <butto type="button" class="btn btn-toll" data-bs-toggle="modal"
                ...
                <div class="card card-light">
                    <div class="card-header border-bottom-0">
                        <strong>Mis targetas de pago</strong>
                        <div class="card-tools">
                            <button type="button" class="btn btn-toll">
                                <i class="fas fa-plus"></i>
                            </button>
                        </div>
                    </div>
